...
export namespace Prisma {
  ...
  */
  ...
  export type TasksOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "title" | "status" | "userId", ExtArgs["result"]["tasks"]>
  ...
  interface TasksFieldRefs {
    ...
    readonly status: FieldRef<"Tasks", 'Boolean'>
  ...
  export type TasksWhereInput = {
    ...
    status?: BoolFilter<"Tasks"> | boolean
  ...
  export type TasksScalarWhereWithAggregatesInput = {
    ...
    status?: BoolWithAggregatesFilter<"Tasks"> | boolean
